...
| <a id="opt-providers-kubernetesCRD-defaultTLSStoreName" href="#opt-providers-kubernetesCRD-defaultTLSStoreName" title="#opt-providers-kubernetesCRD-defaultTLSStoreName">`providers.kubernetesCRD.defaultTLSStoreName`</a> | Name of the `TLSStore` resource to use as the [default TLS store](../../../../reference/routing-configuration/kubernetes/crd/tls/tlsstore.md).<br />It allows multiple Traefik instances sharing a namespace to use different default TLS stores.<br />When empty, the `TLSStore` named `default` is used. | "default" | No |
